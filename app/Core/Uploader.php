...
final class Uploader
{
    ...
    public static function storeImage(array $file, string $subdir, ?int $uploadedBy = null): string
    {
        ...
        if ($file['size'] > self::MAX_BYTES) {
            throw new \RuntimeException('Image must be smaller than 50MB.');
        }
    ...
    {
        return match ($error) {
            UPLOAD_ERR_INI_SIZE, UPLOAD_ERR_FORM_SIZE => 'That image is too large for the server to accept. Please upload one under 50MB.',
